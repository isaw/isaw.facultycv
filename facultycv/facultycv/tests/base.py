...
def setup_product():
    ...
    import facultycv.facultycv
    zcml.load_config('configure.zcml', facultycv.facultycv)
    ...
    ztc.installPackage('facultycv.facultycv')
...
setup_product()
ptc.setupPloneSite(products=['facultycv.facultycv'])
